...
public class TC03_CloseButton_Ask_me_anything extends ExtentReport{

	@Test
	public void closeButtonAskmeAnything() throws InterruptedException, MalformedURLException
	{
		tests = extent.createTest("CloseButton_Ask_me_anything");
        ...
        try {
			 String actual= driver.findElement(By.xpath("//span[contains(text(),'Popular Questions')]")).getText();
				...
				System.out.println("Test case passed -Ask me question closed");
				}
		catch (Exception e)
	         {
			    Assert.assertEquals(true, false, "Test case failed-Help Ask me anything page not closed");
				}
		Thread.sleep(5000);
		driver.close();
