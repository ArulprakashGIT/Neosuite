...
public class TC05_Contribute_question extends ExtentReport{

	@Test
	public void contributeQuestion() throws InterruptedException, MalformedURLException
	{
		tests = extent.createTest("Contribute_question");
        ...
        WebElement upload =driver.findElement(By.xpath("//div[@id='attachment-input-div']//input[@type='file']"));
		upload.sendKeys(System.getProperty("user.dir")+"\\Downloads\\Neeyamo.jpg");
		driver.findElement(By.xpath("//a[contains(text(),'Submit')]")).click();
		try {
			String actual= driver.findElement(By.xpath("//div[contains(text(),'User contribution added')]")).getText();
			String expected= "User contribution added";
			Assert.assertEquals(actual, expected, "Test case fail -Assert fails expected key not matching");
			System.out.println("Test case pass- User contribution added");
