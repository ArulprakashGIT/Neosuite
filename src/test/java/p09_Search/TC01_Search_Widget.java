...
public class TC01_Search_Widget extends BaseClass
{

	@Test
	public void searchWidget() throws InterruptedException, MalformedURLException
	{
		...
		driver.findElement(By.xpath("//div[contains(text(),'Home Page')]")).click();
		break;
	    }
