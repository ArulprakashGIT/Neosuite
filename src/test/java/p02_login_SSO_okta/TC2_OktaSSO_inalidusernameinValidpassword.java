...
public class TC2_OktaSSO_inalidusernameinValidpassword extends ExtentReport{

	@Test
	public void oktaLogin() throws InterruptedException, MalformedURLException
	{
		tests = extent.createTest("OktaSSO_inalidusernameinValidpassword");
		...
		driver.findElement(By.xpath("//input[@type='password']")).sendKeys("Okta@");
